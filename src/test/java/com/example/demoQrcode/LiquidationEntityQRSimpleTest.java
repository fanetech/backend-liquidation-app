...
/**
 * Test simple pour vérifier les nouvelles fonctionnalités QR de l'entité Liquidation
 * Sans Spring Boot pour éviter les problèmes de configuration
 */
public class LiquidationEntityQRSimpleTest {
