...
public class AuthController {
    ...
    /**
     * LOGIN : Authentifie l'utilisateur et retourne un token JWT
     */
    @PostMapping("/login")
    public ResponseEntity<?> login(@RequestBody AuthRequest request) {
        try {
            ...
            // Retourner token dans body + header
    ...
    /**
     * REGISTER : Enregistre un nouvel utilisateur avec rôle par défaut ROLE_USER
     */
